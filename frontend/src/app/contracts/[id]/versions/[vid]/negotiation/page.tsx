...
import { getVersionNegotiation, NegotiationOut } from "@/lib/api";
      ...
      {expanded && (
        <div className="neg-card-body">
          {item.regulatory_basis && (
            <div className="neg-section"><h4>Regulatory basis</h4><p>{item.regulatory_basis}</p></div>
          )}
          ...
          {item.negotiation_argument && (
            <div className="neg-section"><h4>Negotiation argument</h4><p>{item.negotiation_argument}</p></div>
          )}
          {item.fallback_option && (
            <div className="neg-section"><h4>Fallback option</h4><p>{item.fallback_option}</p></div>
          )}
